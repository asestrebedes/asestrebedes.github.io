...
$(window).scroll(function(){
    if ($(this).scrollTop() > 100) {
        ...
        if((scroll > 2130 && scroll < 2610) || (scroll > 4015)) {
            $('.scrolltotop').css('border-color', 'white');
            $('.arrow_color').css('color', 'white');
        } else
        {
            $('.scrolltotop').css('border-color', '#676d75');
            $('.arrow_color').css('color', '#000000');
        }
    } else {
        $('.scrolltotop').fadeOut();
    }
